      ...
      $stateProvider
        ...
        .state('manuals_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['manuals_path'](params);
          },
        ...
        .state('new_manual_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['new_manual_path'](params);
          },
          controller: 'ManualsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
        ...
        .state('edit_manual_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['edit_manual_path'](params);
          },
          controller: 'ManualsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
        ...
        .state('manual_path', {
          ...
          templateUrl: function(params) {
            ...
            return Routes['manual_path'](params);
          },
          controller: 'ManualsCtrl as ctrl',
          resolve: {
            action: ['$stateParams', function ($stateParams) {
...
angular.module("oxymoron.services.resources", [])
  .factory('resourceDecorator', [function () {
    ...
    .factory('Manual', ['$resource', 'resourceDecorator', function ($resource, resourceDecorator) {
      return resourceDecorator($resource('/manuals/:id.json', {"id":"@id"}, {
        "new": {
          "method": "GET",
          "url": "/manuals/:id/new.json"
        },
        "edit": {
          "method": "GET",
          "url": "/manuals/:id/edit.json"
        },
        "update": {
          "method": "PUT"
        },
